...
/* Meta Information */
MODULE_LICENSE("phuong");
MODULE_AUTHOR("phuong GNU/Linux");
MODULE_DESCRIPTION("A simple example for ioctl by phuong");
/**
...
static int __init ModuleInit(void) {
	...
	printk("Hello, Kernel!\n");
	/* register device nr. */
	retval = register_chrdev(MYMAJOR, "phuong_ioctl_example", &fops);
	if(retval == 0) {
